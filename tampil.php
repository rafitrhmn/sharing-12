...
<head>
    ...
    <link rel="stylesheet" type="text/css/booststrap.min.css">
    <style type="text/css">
        body{
...
<?php
	...
	<form method="post" action="">	
		...
		<tr>				
			...
			<tr>
				<td>alamat:</td>
				<td><textarea name="alamat" cols="30" rows="15"></textarea></td>
			</tr>
			<tr>
				<td>no_telepon</td>
			...
			<tr>
				<tr colspan= "2" alighn= "center">
					...
					<td><input type="submit" name="cancel" value="reset"></td>
			</tr>
		</table>
	</form>
